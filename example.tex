...
\FEItitle{Získavanie a spracovanie dát z motion-capture obleku}
\FEItitleEn{Data acquisition and processing from the motion-capture suit}
\FEIkeywords{snímanie pohybu, motion-capture oblek, animácia, spracovanie dát, vzdialené ovládanie}
\FEIkeywordsEn{motion capture, motion-capture suit, animations, data processing, remote control}
\FEIregNr{FEI-5382-97025}
