%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Motion capture} % Analýza
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% V ďalších podsekciách analýzy priblížime používané metódy a procesy, ako aj spracovanie dát a ich formáty, ktoré sa využívajú v moderných motion-capture systémoch. Nakoniec si priblížime, čo by nám v budúcnosti mohol prinesť ďalší vývoj a výskumy v oblasti týchto systémov.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Mechanické motion-capture systémy}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Inžinierstvo}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Iné} % Právo, bezpečnosť a obrana?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
